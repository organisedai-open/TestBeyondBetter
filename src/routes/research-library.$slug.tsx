  ...
  head: ({ loaderData, params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: `https://www.bebeyondbetter.com${loaderData.image}` },
        ...
        { name: "twitter:image", content: `https://www.bebeyondbetter.com${loaderData.image}` },
      ],
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            image: [`https://www.bebeyondbetter.com${loaderData.image}`],
